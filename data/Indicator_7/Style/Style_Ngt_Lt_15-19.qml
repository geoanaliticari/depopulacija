...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" version="3.14.1-Pi" maxScale="0" minScale="1e+08">
  ...
  <pipe>
    <rasterrenderer type="singlebandpseudocolor" band="1" alphaBand="-1" opacity="1" nodataColor="" classificationMax="inf" classificationMin="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="1" maximumValue="inf" classificationMode="2" clip="0" colorRampType="DISCRETE">
          ...
          <item value="1" label="I ≤ 1" alpha="255" color="#000004"/>
