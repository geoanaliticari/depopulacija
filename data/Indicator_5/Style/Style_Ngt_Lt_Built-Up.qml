...
<qgis version="3.14.1-Pi" styleCategories="AllStyleCategories" minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <pipe>
    <rasterrenderer band="1" classificationMax="inf" type="singlebandpseudocolor" opacity="1" nodataColor="" alphaBand="-1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="inf" colorRampType="DISCRETE" clip="0" classificationMode="2" minimumValue="0">
    ...
    <huesaturation colorizeOn="0" saturation="0" colorizeGreen="128" colorizeStrength="100" colorizeBlue="128" colorizeRed="255" grayscaleMode="0"/>
